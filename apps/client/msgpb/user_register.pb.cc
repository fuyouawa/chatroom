...
static ::_pb::Metadata file_level_metadata_user_5fregister_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_user_5fregister_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_user_5fregister_2eproto = nullptr;

const uint32_t TableStruct_user_5fregister_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::chatroom::message::UserRegister, _impl_.name_),
  PROTOBUF_FIELD_OFFSET(::chatroom::message::UserRegister, _impl_.password_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::chatroom::message::UserRegister)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::chatroom::message::_UserRegister_default_instance_._instance,
};
...
const char descriptor_table_protodef_user_5fregister_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static ::_pbi::once_flag descriptor_table_user_5fregister_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_user_5fregister_2eproto = {
    false, false, 95, descriptor_table_protodef_user_5fregister_2eproto,
    "user_register.proto",
    &descriptor_table_user_5fregister_2eproto_once, nullptr, 0, 1,
    schemas, file_default_instances, TableStruct_user_5fregister_2eproto::offsets,
    file_level_metadata_user_5fregister_2eproto, file_level_enum_descriptors_user_5fregister_2eproto,
    file_level_service_descriptors_user_5fregister_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_user_5fregister_2eproto_getter() {
  return &descriptor_table_user_5fregister_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_user_5fregister_2eproto(&descriptor_table_user_5fregister_2eproto);
namespace chatroom {
namespace message {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "chatroom.message.UserRegister.name"));
        } else
          goto handle_unusual;
        continue;
      // string password = 2;
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "chatroom.message.UserRegister.password"));
        } else
          goto handle_unusual;
        continue;
      default:
...
::PROTOBUF_NAMESPACE_ID::Metadata UserRegister::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_user_5fregister_2eproto_getter, &descriptor_table_user_5fregister_2eproto_once,
      file_level_metadata_user_5fregister_2eproto[0]);
}
...
template<> PROTOBUF_NOINLINE ::chatroom::message::UserRegister*
Arena::CreateMaybeMessage< ::chatroom::message::UserRegister >(Arena* arena) {

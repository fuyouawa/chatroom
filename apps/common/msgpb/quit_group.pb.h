...
#ifndef GOOGLE_PROTOBUF_INCLUDED_msgpb_2fquit_5fgroup_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_msgpb_2fquit_5fgroup_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_msgpb_2fquit_5fgroup_2eproto
...
struct TableStruct_msgpb_2fquit_5fgroup_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_msgpb_2fquit_5fgroup_2eproto;
namespace chatroom {
namespace msgpb {
class QuitGroup;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::chatroom::msgpb::QuitGroup* Arena::CreateMaybeMessage<::chatroom::msgpb::QuitGroup>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace chatroom {
namespace msgpb {
...
class QuitGroup PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:chatroom.msgpb.QuitGroup) */ {
 public:
  inline QuitGroup() : QuitGroup(nullptr) {};
  virtual ~QuitGroup();

  QuitGroup(const QuitGroup& from);
  QuitGroup(QuitGroup&& from) noexcept
    : QuitGroup() {
    *this = ::std::move(from);
  }
  ...
  inline QuitGroup& operator=(QuitGroup&& from) noexcept {
  ...
  friend void swap(QuitGroup& a, QuitGroup& b) {
    a.Swap(&b);
  }
  inline void Swap(QuitGroup* other) {
  ...
  inline QuitGroup* New() const final {
    return CreateMaybeMessage<QuitGroup>(nullptr);
  }

  QuitGroup* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<QuitGroup>(arena);
  }
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "chatroom.msgpb.QuitGroup";
  }
  protected:
  explicit QuitGroup(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_msgpb_2fquit_5fgroup_2eproto);
    return ::descriptor_table_msgpb_2fquit_5fgroup_2eproto.file_level_metadata[kIndexInFileMessages];
  }
 ...
 private:
  ...
  friend struct ::TableStruct_msgpb_2fquit_5fgroup_2eproto;
};
// ===================================================================
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_msgpb_2fquit_5fgroup_2eproto

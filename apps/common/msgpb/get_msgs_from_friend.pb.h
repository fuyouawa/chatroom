...
#ifndef GOOGLE_PROTOBUF_INCLUDED_get_5fmsgs_5ffrom_5ffriend_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_get_5fmsgs_5ffrom_5ffriend_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_get_5fmsgs_5ffrom_5ffriend_2eproto
...
struct TableStruct_get_5fmsgs_5ffrom_5ffriend_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_get_5fmsgs_5ffrom_5ffriend_2eproto;
namespace chatroom {
namespace msgpb {
...
class GetMsgsFromFriend PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_get_5fmsgs_5ffrom_5ffriend_2eproto);
    return ::descriptor_table_get_5fmsgs_5ffrom_5ffriend_2eproto.file_level_metadata[kIndexInFileMessages];
  }
 ...
 private:
  ...
  friend struct ::TableStruct_get_5fmsgs_5ffrom_5ffriend_2eproto;
};
// ===================================================================
...
inline ::PROTOBUF_NAMESPACE_ID::int32 GetMsgsFromFriend::_internal_user_id() const {
  return user_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 GetMsgsFromFriend::user_id() const {
  // @@protoc_insertion_point(field_get:chatroom.msgpb.GetMsgsFromFriend.user_id)
  return _internal_user_id();
}
inline void GetMsgsFromFriend::_internal_set_user_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  user_id_ = value;
}
inline void GetMsgsFromFriend::set_user_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 GetMsgsFromFriend::_internal_friend_id() const {
  return friend_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 GetMsgsFromFriend::friend_id() const {
  // @@protoc_insertion_point(field_get:chatroom.msgpb.GetMsgsFromFriend.friend_id)
  return _internal_friend_id();
}
inline void GetMsgsFromFriend::_internal_set_friend_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  friend_id_ = value;
}
inline void GetMsgsFromFriend::set_friend_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_get_5fmsgs_5ffrom_5ffriend_2eproto

...
class UserRegister PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_user_5fregister_2eproto);
    return ::descriptor_table_user_5fregister_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline void UserRegister::set_name(std::string&& value) {
...
inline void UserRegister::unsafe_arena_set_allocated_name(
    std::string* name) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (name != nullptr) {
...
inline void UserRegister::unsafe_arena_set_allocated_password(
    std::string* password) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (password != nullptr) {

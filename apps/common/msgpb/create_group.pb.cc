...
#include "msgpb/create_group.pb.h"
...
static void InitDefaultsscc_info_CreateGroup_msgpb_2fcreate_5fgroup_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_CreateGroup_msgpb_2fcreate_5fgroup_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_CreateGroup_msgpb_2fcreate_5fgroup_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_msgpb_2fcreate_5fgroup_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_msgpb_2fcreate_5fgroup_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_msgpb_2fcreate_5fgroup_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_msgpb_2fcreate_5fgroup_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_msgpb_2fcreate_5fgroup_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\030msgpb/create_group.proto\022\016chatroom.msg"
  "pb\"2\n\013CreateGroup\022\017\n\007user_id\030\001 \001(\r\022\022\n\ngr"
  "oup_name\030\002 \001(\tb\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_msgpb_2fcreate_5fgroup_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_msgpb_2fcreate_5fgroup_2eproto_sccs[1] = {
  &scc_info_CreateGroup_msgpb_2fcreate_5fgroup_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_msgpb_2fcreate_5fgroup_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_msgpb_2fcreate_5fgroup_2eproto = {
  false, false, descriptor_table_protodef_msgpb_2fcreate_5fgroup_2eproto, "msgpb/create_group.proto", 102,
  &descriptor_table_msgpb_2fcreate_5fgroup_2eproto_once, descriptor_table_msgpb_2fcreate_5fgroup_2eproto_sccs, descriptor_table_msgpb_2fcreate_5fgroup_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_msgpb_2fcreate_5fgroup_2eproto::offsets,
  file_level_metadata_msgpb_2fcreate_5fgroup_2eproto, 1, file_level_enum_descriptors_msgpb_2fcreate_5fgroup_2eproto, file_level_service_descriptors_msgpb_2fcreate_5fgroup_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_msgpb_2fcreate_5fgroup_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_msgpb_2fcreate_5fgroup_2eproto)), true);
namespace chatroom {
namespace msgpb {
...
void CreateGroup::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_CreateGroup_msgpb_2fcreate_5fgroup_2eproto.base);
  group_name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  user_id_ = 0u;
}

...
static void InitDefaultsscc_info_UserLoginAck_user_5flogin_5fack_2eproto() {
  ...
  {
    void* ptr = &::chatroom::msgpb::_UserLoginAck_default_instance_;
    new (ptr) ::chatroom::msgpb::UserLoginAck();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::chatroom::msgpb::UserLoginAck::InitAsDefaultInstance();
}
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_user_5flogin_5fack_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::chatroom::msgpb::UserLoginAck, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::chatroom::msgpb::_UserLoginAck_default_instance_),
};
...
UserLoginAck::UserLoginAck(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:chatroom.msgpb.UserLoginAck)
}
...
UserLoginAck::~UserLoginAck() {
  // @@protoc_insertion_point(destructor:chatroom.msgpb.UserLoginAck)
  SharedDtor();
...
// @@protoc_insertion_point(message_clear_start:chatroom.msgpb.UserLoginAck)
...
::PROTOBUF_NAMESPACE_ID::uint8* UserLoginAck::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:chatroom.msgpb.UserLoginAck)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (this->errmsg().size() > 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      "chatroom.msgpb.UserLoginAck.errmsg");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:chatroom.msgpb.UserLoginAck)
  return target;
}

size_t UserLoginAck::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:chatroom.msgpb.UserLoginAck)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:chatroom.msgpb.UserLoginAck)
  GOOGLE_DCHECK_NE(&from, this);
  const UserLoginAck* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<UserLoginAck>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:chatroom.msgpb.UserLoginAck)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:chatroom.msgpb.UserLoginAck)
    MergeFrom(*source);
  }
}

void UserLoginAck::MergeFrom(const UserLoginAck& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:chatroom.msgpb.UserLoginAck)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:chatroom.msgpb.UserLoginAck)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:chatroom.msgpb.UserLoginAck)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::chatroom::msgpb::UserLoginAck* Arena::CreateMaybeMessage< ::chatroom::msgpb::UserLoginAck >(Arena* arena) {
  return Arena::CreateMessageInternal< ::chatroom::msgpb::UserLoginAck >(arena);
}

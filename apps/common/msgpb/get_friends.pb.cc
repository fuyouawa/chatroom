...
static void InitDefaultsscc_info_GetFriends_get_5ffriends_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_GetFriends_get_5ffriends_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_GetFriends_get_5ffriends_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_get_5ffriends_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_get_5ffriends_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_get_5ffriends_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_get_5ffriends_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_get_5ffriends_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\021get_friends.proto\022\016chatroom.msgpb\"\035\n\nG"
  "etFriends\022\017\n\007user_id\030\001 \001(\005b\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_get_5ffriends_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_get_5ffriends_2eproto_sccs[1] = {
  &scc_info_GetFriends_get_5ffriends_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_get_5ffriends_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_get_5ffriends_2eproto = {
  false, false, descriptor_table_protodef_get_5ffriends_2eproto, "get_friends.proto", 74,
  &descriptor_table_get_5ffriends_2eproto_once, descriptor_table_get_5ffriends_2eproto_sccs, descriptor_table_get_5ffriends_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_get_5ffriends_2eproto::offsets,
  file_level_metadata_get_5ffriends_2eproto, 1, file_level_enum_descriptors_get_5ffriends_2eproto, file_level_service_descriptors_get_5ffriends_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_get_5ffriends_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_get_5ffriends_2eproto)), true);
namespace chatroom {
namespace msgpb {
...
const GetFriends& GetFriends::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_GetFriends_get_5ffriends_2eproto.base);
